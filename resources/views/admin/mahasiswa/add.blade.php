    ...
    <div class="row mt-2">
        <div class="col-md-7">
            <div class="card border-0 shadow-sm">
                <div class="card-body">
                    <form method="post" action="{{ route('admin.mahasiswa.add-post') }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="nim"
                                   ...
                                   placeholder="Nomer Induk Mahasiswa" value="{{ old('nim') }}">
                            @error('nim')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text"
                                   ...
                                   id="nama"
                                   placeholder="Nama Lengkap Mahasiswa" value="{{ old('nama') }}">
                            @error('nama')
                            <div id="nama" class="invalid-feedback">
                                {{ $message }}
                            </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="nomerTelp"
                                   ...
                                   id="nama" placeholder="Nomer Telephone" value="{{ old('nomerTelp') }}">
                            @error('nomerTelp')
                            <div id="nama" class="invalid-feedback">
                                {{ $message }}
                            </div>
